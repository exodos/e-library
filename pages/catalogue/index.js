          ...
          <div className="sm:flex sm:items-center">
            ...
            {allowed && (
              <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <Link href="/catalogue/add-catalogue" passHref>
                  <button
                    type="button"
                    className="inline-flex items-center justify-center rounded-md border border-transparent bg-lightGreen px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-deepGreen focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:w-auto"
                  >
                    <PlusCircleIcon
